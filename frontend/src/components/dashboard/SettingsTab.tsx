  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto py-2">
      <div className="space-y-1">
        ...
        <p className="text-sm text-slate-500">Configure your profile info, security metrics, and application alerts.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="border border-slate-100 bg-white p-4 rounded-2xl shadow-sm h-fit space-y-1">
          <button className="w-full flex items-center space-x-3 px-3 py-2 bg-blue-50 text-blue-600 font-bold rounded-lg text-xs transition-all text-left">
            <User className="w-4 h-4" />
            <span>Profile Details</span>
          </button>
          <button className="w-full flex items-center space-x-3 px-3 py-2 text-slate-500 hover:bg-slate-50 rounded-lg text-xs transition-all text-left">
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <div className="border border-slate-100 bg-white p-5 rounded-2xl shadow-sm space-y-4">
            <h3 className="text-sm font-bold text-slate-700 pb-2 border-b border-slate-100 flex items-center space-x-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 text-xs focus:outline-none focus:border-blue-500 text-slate-800 bg-white"
                  />
                </div>
                <div className="space-y-1">
          ...
          <div className="border border-slate-100 bg-white p-5 rounded-2xl shadow-sm space-y-4">
            ...
            <form onSubmit={handleUpdatePassword} className="space-y-3">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1">
                  <label className="text-[11px] font-semibold text-slate-500">Current Password</label>
                  <input
                    type="password"
                    placeholder="••••••••"
          ...
          <div className="border border-slate-100 bg-white p-5 rounded-2xl shadow-sm space-y-4">
            <h3 className="text-sm font-bold text-slate-700 pb-2 border-b border-slate-100">Connected Accounts</h3>
            <div className="flex justify-between items-center bg-slate-50 p-4 rounded-xl border border-slate-100">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-slate-400">Single Sign-On integration active</p>
                </div>
              </div>
